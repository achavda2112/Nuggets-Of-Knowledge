...
public class AssignReviewer extends webDriverSetup{

	 public static void main(String[] args) throws Exception{
		 WebDriver driver = getDriver();
		 NOK_Management_Functions AssignReviewer = new NOK_Management_Functions();
		 ...
		 AssignReviewer.addNOK();
		 AssignReviewer.CheckIn();
		 AssignReviewer.AssignReviewer();
		 AssignReviewer.TestCaseFinished();
		 driver.quit();
		 }		
}
