...
public class NOK_Management_Locators {
	...
	public static final String NuggetEDIT = "//a[@id='nuggetList_Edit_1']";
	public static final String NuggetArchive = "//a[@id='nuggetList_Archive_1']";
	public static final String MoveTODraft = "//a[@id='nuggetList_MoveDraft_5']";
